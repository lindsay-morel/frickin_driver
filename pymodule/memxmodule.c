...
const int _wrap_memx_dma_trigger_type_chip = MEMX_CHIP_INPUT_DMA_TRIGGER_TYPE_CHIP;
const int _wrap_memx_dma_trigger_type_host = MEMX_CHIP_INPUT_DMA_TRIGGER_TYPE_HOST;
...
static PyObject* _wrap_memx_get_frequency_effective(PyObject* self, PyObject* args)
{
  memx_status status;
  uint64_t value;
  uint8_t group_id;
  ...
  {
    Py_BEGIN_ALLOW_THREADS
    status = memx_get_feature(group_id, chip_id, OPCODE_GET_FREQUENCY_EFFECTIVE, &value);
    Py_END_ALLOW_THREADS
  }
...
static PyObject* _wrap_memx_get_dma_trigger_type(PyObject* self, PyObject* args)
{
  memx_status status;
  uint64_t value;
  uint8_t group_id;
  ...
  {
    Py_BEGIN_ALLOW_THREADS
    status = memx_get_feature(group_id, chip_id, OPCDOE_GET_DEVICE_DMA_TRIGGER_TYPE, &value);
    Py_END_ALLOW_THREADS
  }
...
static PyObject* _wrap_memx_set_dma_trigger_type(PyObject* self, PyObject* args)
{
  memx_status status = MEMX_STATUS_OK;
  uint16_t value = 0;
  uint8_t group_id = 0;
  ...
  {
    Py_BEGIN_ALLOW_THREADS
    status = memx_set_feature(group_id, chip_id, OPCDOE_SET_DEVICE_DMA_TRIGGER_TYPE, value);
    Py_END_ALLOW_THREADS
  }
...
static PyObject* _wrap_memx_stream_ifmap(PyObject* self, PyObject* args, PyObject *kwargs)
{
  ...
  {
    if (chip_gen == MEMX_DEVICE_CASCADE_PLUS) {
    ...
    else { status = MEMX_STATUS_OTHERS; }
  }
...
static PyObject* _wrap_memx_write_vendor_id(PyObject* self, PyObject* args)
{
  memx_status status = MEMX_STATUS_OK;
  PyObject *byte_obj;
  uint32_t length = 0;
  ...
  if(!PyArg_ParseTuple(args, "bIO!", &group_id, &length, &PyBytes_Type, &byte_obj)) {
    PyErr_BadArgument();
    return NULL;
  }
  ...
  {
    Py_BEGIN_ALLOW_THREADS
    status = memx_write_vendor_id(group_id, length, data);
    Py_END_ALLOW_THREADS
  }
...
static PyObject* _wrap_memx_read_vendor_id(PyObject* self, PyObject* args)
{
  memx_status status = MEMX_STATUS_OK;
  PyObject *byte_obj;
  uint32_t length = 0;
  ...
  if(!PyArg_ParseTuple(args, "bIO!", &group_id, &length, &PyByteArray_Type, &byte_obj)) {
    PyErr_BadArgument();
    return NULL;
  }

  Py_ssize_t buf_size = PyByteArray_Size(byte_obj);

  if ((Py_ssize_t)length > buf_size) {
      PyErr_SetString(PyExc_ValueError, "length larger than buffer size");
      return NULL;
  }

  uint8_t *data = (uint8_t *)PyByteArray_AsString(byte_obj);

    Py_BEGIN_ALLOW_THREADS
    status = memx_read_vendor_id(group_id, length, data);
    Py_END_ALLOW_THREADS

    (void)self;
    return Py_BuildValue("K", (unsigned long long)status);
}

static PyObject* _wrap_memx_erase_vendor_id(PyObject* self, PyObject* args)
{
  memx_status status = MEMX_STATUS_OK;
  uint32_t length = 0;
  uint8_t group_id = 0;

  if(!PyArg_ParseTuple(args, "bI", &group_id, &length)) {
    PyErr_BadArgument();
    return NULL;
  }

    Py_BEGIN_ALLOW_THREADS
    status = memx_erase_vendor_id(group_id, length);
    Py_END_ALLOW_THREADS
...
static PyMethodDef MemxMethods[] = {
  ...
  {"get_frequency_effective", (PyCFunction)_wrap_memx_get_frequency_effective, METH_VARARGS|METH_KEYWORDS, NULL},
  ...
  {"get_dma_trigger_type", (PyCFunction)_wrap_memx_get_dma_trigger_type, METH_VARARGS|METH_KEYWORDS, NULL},
  ...
  {"set_dma_trigger_type", (PyCFunction)_wrap_memx_set_dma_trigger_type, METH_VARARGS, NULL},
  ...
  {"write_vendor_id", (PyCFunction)_wrap_memx_write_vendor_id, METH_VARARGS, NULL},
  {"read_vendor_id", (PyCFunction)_wrap_memx_read_vendor_id, METH_VARARGS, NULL},
  {"erase_vendor_id", (PyCFunction)_wrap_memx_erase_vendor_id, METH_VARARGS, NULL},
...
PyInit_mxa(void)
{
  ...
  PyModule_AddIntConstant(module, "memx_dma_trigger_type_chip", _wrap_memx_dma_trigger_type_chip);
  PyModule_AddIntConstant(module, "memx_dma_trigger_type_host", _wrap_memx_dma_trigger_type_host);
