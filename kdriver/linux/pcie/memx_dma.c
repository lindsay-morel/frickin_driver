...
#define DMAC_CH_SETREG(memx_dev, chip_id, reg_offset, ch, value) memx_xflow_write(memx_dev, chip_id, (ARM_DMA_BASE+(0x100*ch)+reg_offset), 0, value, false)
#define DMAC_CH_GETREG(memx_dev, chip_id, reg_offset, ch)        memx_xflow_read(memx_dev,  chip_id, (ARM_DMA_BASE+(0x100*ch)+reg_offset), 0, false)
